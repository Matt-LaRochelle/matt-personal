...
function Projects2() {
    ...
    return (
        <div className="projects2" onTouchStart={handleMouseDown} onMouseDown={handleMouseDown}>
            <Navbar />
            <div className="projects__container2">

                {/* <h1>Projects</h1> */}
                <div className="projects__helper2">
                    <h4>Welcome to my portfolio!</h4>
                    <p>Tap or click and drag right to left to view projects</p>
                </div>
                <div 
                    className="projects__image-track2"
                    style={{
                    ...
                    {projectInfo.map((project, index) => {
                        return (
                            <Link to={project.link} key={index}>
                                <div className="projects__card2">
                                    <img 
                                        src={project.image} 
                                        alt={project.title} 
                                        draggable="false"
                                        style={{objectPosition: `${percentage + 100}% 50%`}} />
                                    <p className="projects__title2">{project.title} {project.type}</p>
                                </div>
                            </Link>
                        )})
                    }
                </div>
                {/* <div className="stateVariables2">
                    <p>Start X = {startX}</p>
